...
set_property IOSTANDARD LVCMOS33 [get_ports {display_mode[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {display_mode[0]}]
...
set_property PACKAGE_PIN R2 [get_ports {display_mode[2]}]
set_property PACKAGE_PIN T1 [get_ports {display_mode[1]}]
set_property PACKAGE_PIN U1 [get_ports {display_mode[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {display_mode[2]}]
